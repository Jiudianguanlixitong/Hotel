...
<table align="center" border="1">
    <tr><td>房间号</td><td>楼层</td><td>朝向</td><td>房间介绍</td><td>类型</td><td>价格</td><td>预订</td></tr>
    <% ArrayList<Room_Info> room_infos=(ArrayList<Room_Info>)request.getAttribute("room_infos");
         for(int i=0;i<room_infos.size();i++){
    %>
    <tr>
        <td><%=room_infos.get(i).getRoom_id() %></td>
        <td><%=room_infos.get(i).getFloors() %></td>
        <td><%=room_infos.get(i).getFace() %></td>
