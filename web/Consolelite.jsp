                ...
                <div class="tab-content">
                    ...
                    <%--<div id="UserSetting" class="tab-pane">--%>
                        <%--<div id="UserForm">--%>
                            ...
                            <%--&lt;%&ndash;<a href="QueryAllUser?type=cus#UserSetting" id="QueryUser" onclick="location.reload()">查看所有注册用户</a><br/>&ndash;%&gt;--%>
                            ...
                            <%--<table class="table table-bordered">--%>
                                ...
                                <%--<tr>--%>
                                    ...
                                    <%--<td>--%>
                                        <%--<form action=""></form>--%>
                                        <%--&lt;%&ndash;<input type="submit" value="删除"><br/>&ndash;%&gt;--%>
                                    ...
                                    <%--<td>--%>
                                        <%--<form action="AccountSet" id="delStaff" method="get">--%>
                                            <%--<input type="hidden" value="<%= res.getUsername()%>"--%>
                                                   <%--name="username">--%>
                                            <%--&lt;%&ndash;<input type="submit" value="删除">&ndash;%&gt;--%>
